...
src_prepare() {
	# eapply "${FILESDIR}"/${PN}-3.20.1-depend-on-elogind-instead-of-systemd.patch
	...
	# elogind for wayland support
	eapply "${FILESDIR}/${PN}-3.20.1-link-against-elogind-library-instead-of-systemd.patch"
